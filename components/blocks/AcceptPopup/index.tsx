  ...
  return (
    <div className={styles.root + classNames({
      ...
      <button className={styles.close} onClick={() => setIsVisible(false)}>
        <svg className={styles.closeIcon} width="10px" height="10px" viewBox="0 0 23 23" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"> <desc>Close</desc> <g stroke="none" strokeWidth="1" fill="#5E1CEB" fillRule="evenodd"> <rect transform="translate(11.313708, 11.313708) rotate(-45.000000) translate(-11.313708, -11.313708) " x="10.3137085" y="-3.6862915" width="2" height="30"></rect> <rect transform="translate(11.313708, 11.313708) rotate(-315.000000) translate(-11.313708, -11.313708) " x="10.3137085" y="-3.6862915" width="2" height="30"></rect> </g> </svg>
      </button>
