  ...
  const rusItems: Array<TFaq> = [
    {
      ...
      description: [
        ...
        'Создание и публикация Light pepper проекта',
        'Разработка NFT коллекции',
        'Разработка NFT апгрейдов и акссесуаров',
      ],
      color: '#C03DD5'
    },
    {
      date: 'Ноябрь',
      description: [
        'Запуск community проекта',
        'Написание smart-contract для листинга NFT коллекции',
        'Публикация токеномики',
        'Запуск маркетинговой компании',
        'Разработка UX/UI приложения',
      ],
      color: '#A849DE'
    },
    {
      ...
      description: [
        'Публикация white paper проекта',
        'Старт продаж NFT коллекции',
        'Интеграции с блогерами',
        'Договариваемся c DEX/CEX биржами для листинга токена',
      ],
      color: '#7562F2'
    },
    {
      date: 'Январь',
      description: [
        'Запуск Альфа версии приложения - Garage, GPS Tracker, City Map, Minting',
        'Создание бесплатной академии Veemans для всех участников приложения',
      ],
      color: '#4B83FB'
    },
    {
      date: 'Февраль',
      description: [
        'Запуск Beta версии приложения',
        'Тестирование системы на наличие багов и доработка технических решений',
        'Запуск собственной торговой NFT площадки - для покупки и продажи veeman и тюнинга',
        'Добавление игровой механики сражений в пошаговых мини-играх PVP'
      ],
      color: '#33A9F8'
    },
    {
      date: 'Март',
      description: [
        'Запуск версии 1.0 приложения',
        'Добавление игровых механик: создание альянсов, захваты территорий',
        'Листинг токена на DEX и CEX',
        'Добавление функции создания NFT аватара пользователя',
        'Скоро больше обновлений'
      ],
      color: '#1DCEF5'
    },
  ];
